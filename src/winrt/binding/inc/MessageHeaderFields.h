...
public ref class MessageHeaderFields sealed {
  public:
    ///<summary>Returns a string representation of the header fields.</summary>
    ///<param name=" indent">Indentation level.</param>
    ///<returns>The string representation of the header fields.</returns>
    Platform::String ^ ConvertToString(uint32_t indent);

    ///<summary>The header field values.</summary>
    property Platform::Array<MsgArg ^> ^ Field
    {
        Platform::Array<MsgArg ^> ^ get();
    }

    ///<summary>Table to identify which header fields can be compressed.</summary>
    property Platform::Array<bool> ^ Compressible
    {
        Platform::Array<bool> ^ get();
    }

    ///<summary>Table to map the header field to a AllJoynTypeId</summary>
    property Platform::Array<AllJoynTypeId> ^ FieldType
    {
