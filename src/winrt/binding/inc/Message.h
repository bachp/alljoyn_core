...
public ref class Message sealed {
  public:
    ///<summary>Determine if message is a broadcast signal.</summary>
    ///<returns>
    ///Return true if this is a broadcast signal.
    ///</returns>
    bool IsBroadcastSignal();
    ///<summary>Messages broadcast to all devices are global broadcast messages.</summary>
    ///<returns>
    ///   Return true if this is a global broadcast message.
    ///</returns>
    bool IsGlobalBroadcast();

    ///<summary>Return true if message's TTL header indicates that it is expired</summary>
    ...
    ///<summary>Return the arguments for this message.</summary>
    ...
    ///<summary>Return a specific argument for this message.</summary>
    ...
    ///<summary>Get a string representation of the message</summary>
    ///<returns>string representation of the message</returns>
    Platform::String ^ ConvertToString();

    ///<summary>If the message is an error message returns the error name and optionally the error message string</summary>
    ...
    ///<summary>Return the type of the <c>Message</c></summary>
    property AllJoynMessageType Type
    {
    ...
    ///<summary>Accessor function to get the signature for this message</summary>
    ///<returns>
    ...
    ///<summary>Accessor function to get the object path for this message</summary>
    ///<returns>
    ...
    ///<summary>Accessor function to get the interface for this message</summary>
    ///<returns>
    ...
    ///<summary>Accessor function to get the member (method/signal) name for this message</summary>
    ///<returns>
    ...
    ///<summary>Accessor function to get the reply serial number for the message. Only meaningful for #MESSAGE_METHOD_RET</summary>
    ///<returns>
    ...
    ///<summary>Accessor function to get the sender for this message.</summary>
    ///<returns>
    ...
    ///<summary>Get the unique name of the endpoint that the message was received on.</summary>
    ...
    ///<summary>Accessor function to get the destination for this message</summary>
    ///<returns>
    ...
    ///<summary>Accessor function to get the compression token for the message.</summary>
    ///<returns>
    ...
    ///<summary>Accessor function to get the session id for the message.</summary>
    ///<returns>
